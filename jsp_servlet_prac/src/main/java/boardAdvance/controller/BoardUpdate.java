...
public class BoardUpdate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("mainBoardDTO", BoardAdvanceDAO.getInstance().getBoardDetail(boardId, false) );
		
		RequestDispatcher dis = request.getRequestDispatcher("step3_boardAdvanceExxx/board/boardUpdate.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		mainBoardDTO.setPassword(request.getParameter("passwd"));
